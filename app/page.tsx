      ...
      <div className="relative isolate pt-14 dark:bg-zinc-900">
        ...
        >
          <div
            ...
            -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[#FF1D1F] 
            to-[#AB0329] opacity-20 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem]"
            style={{
              clipPath:
        ...
        <div className="py-12 sm:py-20 lg:pb-40">
          ...
          <div className="mt-10 flex items-center justify-center gap-x-6">
            <Link href="/chat">
              <div className="rounded-md bg-orange-600 px-3.5 py-2.5 text-sm font-semibold text-white dark:text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
                Empezar
              </div>
            </Link>
            <Link href="/pricing">
              <div className="text-sm font-semibold leading-6 text-gray-900 dark:text-gray-300">
        ...
        >
          ...
          -translate-x-1/2 bg-gradient-to-tr from-[#FF1D1F] to-[#AB0329] opacity-20 
