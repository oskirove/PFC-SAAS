      ...
      <div className="relative isolate pt-14 dark:bg-gray-900">
        ...
        >
          <div
            ...
            to-[#9089fc] opacity-40 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem]"
            style={{
              clipPath:
        ...
        <div className="py-12 sm:py-20 lg:pb-40">
          ...
          <div className="mt-10 flex items-center justify-center gap-x-6">
            <Link href="/chat">
              <div className="rounded-md bg-indigo-600 px-3.5 py-2.5 text-sm font-semibold text-white dark:text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
                Empezar
              </div>
            </Link>
            <Link href="/pricing">
        ...
        >
          ...
          -translate-x-1/2 bg-gradient-to-tr from-[#ff80b5] to-[#9089fc] opacity-40 
